...
if sys.platform.startswith('win32'):
    ...
    from lib.win32_gdi import PFD_DRAW_TO_WINDOW, PFD_SUPPORT_OPENGL, PFD_DOUBLEBUFFER, PFD_TYPE_RGBA, \
                            PixelFormatDescriptor, get_dc, choose_pixel_format, set_pixel_format, \
                            get_pixel_format, swap_buffers


    from lib.glfunctions import wglCreateContext, wglMakeCurrent

else :
    raise OSError("Error, this requires windows")
